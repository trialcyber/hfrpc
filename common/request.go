...
func ParseSingleRequestBody(jsonMap map[string]interface{}) (
	id interface{},
	jsonrpc string,
	method string,
	params interface{},
...
func Rs(id interface{}, method string, params interface{}) interface{} {
	var req interface{}
	if id != nil {
		req = Request{id.(string), JsonRpc, method, params, map[string]interface{}{}}
	} else {
		req = NotifyRequest{JsonRpc, method, params, map[string]interface{}{}}
	}
	return req
}
